...
\tightlist
\item
  the corresponding nominalisation as a related prime (e.g., \mention{paleness} preceding \mention{pale});
\item
...
Out of 95 -\mention{ness} items pre-tested, 30 were selected for the main experiment to cover the range continuously \autocite[1115]{heyer-kornishova-2018-priming-eventually}. The Russian experiment used a parallel design with 30 -\mention{ost'} nominalisations spanning a similar range.
