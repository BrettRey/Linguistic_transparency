...
The table is a topology map, not a second set of worked cases. Aleut is the qualified positive; the head-marked and obviation entries remain conditional on the analyses and falsification conditions stated in the table. Lardil, Kayardild, and Chamorro mark candidate applications rather than established instances because an independently motivated same-family concealing control has not been shown.
