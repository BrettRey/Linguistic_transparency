...
\mention{rest} & \mention{the} & $\checkmark$ (\mention{the rest of the time}); bare whole only if bounded and unique (\mention{the rest of society}) & n/a: not a quantity noun & sg/pl (complement-controlled) \\
\addlinespace
