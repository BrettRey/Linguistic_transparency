...
The pilot reported with the joint analysis supplies a bounded check on the category contrast. In a sample of 50 \mention{call} hits, 17 were genuine AP-nucleus TFRs and 14 occurred in the externally predicative position. Exhaustive checks of 178 adjective hits with \mention{seem} or \mention{appear} found no genuine non-NP nucleus. This is distributional evidence, not a completed acceptability study; the relevant category-discriminating environments and judgments remain to be added to the joint paper.
