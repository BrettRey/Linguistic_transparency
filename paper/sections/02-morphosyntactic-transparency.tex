...
The pilot reported with the joint analysis supplies a bounded check on the category contrast. In a sample of 50 \mention{call} hits, 17 were genuine AP-nucleus TFRs and 14 occurred in the externally predicative position. Exhaustive checks of the candidate set for right-edge non-NP nuclei with \mention{seem} or \mention{appear} (296 tokens across four queries, re-verified against COCA) found no genuine case; the working paper reports the query details. This is distributional evidence, not a completed acceptability study; the relevant category-discriminating environments and judgments remain to be added to the joint paper.
